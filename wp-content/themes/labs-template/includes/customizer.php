...
class MgCustomizer
{
    ...
    public static function ajout_personnalisation_about($wp_customize)
    {
        ...
        // CONTACT PAGE
        // Control pour la Google map
        $wp_customize->add_control(
            new WP_Customize_Control(
                $wp_customize,
                'google-map',
                array(
                    'label' => __("Entrez l'adresse", 'theme_name'),
                    'section' => 'labs-maps',
                    'settings' => 'labs-contact-google',
                    'type' => 'url',
                    'choices' => array()
                )
            )
