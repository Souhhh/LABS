...
<head>
  ...
  <!-- Favicon -->
  <link href="http://localhost:8080/wp-content/themes/labs-template/img/favicon.ico" rel="shortcut icon" />

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Oswald:300,400,500,700|Roboto:300,400,700" rel="stylesheet">

  <!-- Stylesheets -->
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/bootstrap.min.css" />
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/font-awesome.min.css" />
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/flaticon.css" />
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/magnific-popup.css" />
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/owl.carousel.css" />
  <link rel="stylesheet" href="http://localhost:8080/wp-content/themes/labs-template/css/style.css" />
...
<body>
  ...
  <div id="preloder">
    <div class="loader">
      <img src="http://localhost:8080/wp-content/themes/labs-template/img/logo.png" alt="">
      <h2>Loading.....</h2>
    </div>
  </div>
  ...
  <header class="header-section">
    <div class="logo">
      <img src="http://localhost:8080/wp-content/themes/labs-template/img/logo.png" alt=""><!-- Logo -->
    </div>
    <!-- Navigation -->
  ...
  <!--====== Javascripts & Jquery ======-->
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/jquery-2.1.4.min.js"></script>
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/bootstrap.min.js"></script>
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/magnific-popup.min.js"></script>
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/owl.carousel.min.js"></script>
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/circle-progress.min.js"></script>
  <script src="http://localhost:8080/wp-content/themes/labs-template/js/main.js"></script>
</body>
